...
.topic_bus{
  ...
  <body>
            ...
            <?php include("navbar.php");
             ...
             <div class="about-sec">
        <div class="about-img">
            <img src="assets/img/bsimgstat.jpg">
        </div>
        <div class="about-intro">
            <h3>About Us<span style="color: #00b894;"> !</h3>
            <p>Here We are going to provide one user friendly bus registration platform that provide effiecient way for ticket booking or trip planning etc.
</div>
    </div>
...
<h1 class="topic_bus"> ...Our Route Services...</h1>
             ...
             <div class="about-sec">
        <div class="about-img">
            <img src="assets/img/bsimgstat1.png">
        </div>
        <div class="about-intro">
